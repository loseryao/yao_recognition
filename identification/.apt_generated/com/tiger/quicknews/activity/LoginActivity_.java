    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        tv = ((TextView) hasViews.findViewById(id.textView1));
        buttonRegister = ((Button) hasViews.findViewById(id.buttonRegister));
        buttonLogin = ((Button) hasViews.findViewById(id.buttonLogin));
        if (buttonRegister!= null) {
            buttonRegister.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    LoginActivity_.this.ButtonRegisterClicked();
                }
        ...
        if (buttonLogin!= null) {
            buttonLogin.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    LoginActivity_.this.ButtonLoginClicked();
                }
