...
public class DetailsActivity extends BaseActivity implements ImageLoadingListener,
    ...
    private ArrayList<String> page_seq;
    ...
    public void init() {
        try {
            ...
            newUrl = getUrl(newID);
            fbean = (App)getApplication();
            m = fbean.getTime_on_page();
            page_seq = (ArrayList<String>) fbean.getPage_seq(); 
            page_seq.add(newID);
            fbean.setPage_seq(page_seq);
            long time = System.currentTimeMillis();
            m.put(newID, time);
            fbean.setTime_on_page(m);
            ...
            back.setOnClickListener(new View.OnClickListener(){
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					 Map<String,Long> m = fbean.getTime_on_page();
		    		 long time = System.currentTimeMillis() - m.get(newID);
		         	 m.put(newID, time);
		         	 fbean.setTime_on_page(m);
    ...
    public void getResult(String result) {
        ...
        StringHandle sh= new StringHandle(content);
        sh.clearString(content);
        int wordscount=sh.getWordsCount();
        List<Integer> wordscounts = fbean.getWordsCount();
        wordscounts.add(wordscount);
        fbean.setWordsCount(wordscounts);
